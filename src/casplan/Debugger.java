...
public class Debugger extends javax.swing.JDialog {
  ...
  private void initComponents() {
    ...
    code = new JTextPane() {
      public void paintComponent(Graphics g) {
        ...
        int textHeight = fm.getHeight() + 1;// * function.line;

        g2.fillRect(0, textHeight * (function.line - 1) + 2, getWidth(), 4);
    ...
    setModal(true);
    setName(""); // NOI18N
    setPreferredSize(new java.awt.Dimension(640, 606));
  ...
  public void init() {
    ...
    for (int j = 0; j < tabs.length; j++) {
      tabs[j] = new TabStop((j + 1) * charWidth * 2);
    }

    TabSet tabSet = new TabSet(tabs);
    SimpleAttributeSet attributes = new SimpleAttributeSet();
    StyleConstants.setTabSet(attributes, tabSet);
    int length = code.getDocument().getLength();
    code.getStyledDocument().setParagraphAttributes(0, length
        , attributes, true);
